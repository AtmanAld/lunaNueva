...
export const createStoreSlice = (set, get) => ({
  ...
  catalog: [
    ...
    { id: 'polvo_lunar', name: 'Polvo Lunar', icon: '✨', price: 188, category: 'Magia', description: 'Polvo mágico para desbloquear casillas especiales o nuevas páginas.', chips: ['Premium', '1 uso', 'Funcional'], payload: { type: 'UNLOCK_TOOL' } },
    { id: 'reloj_cosmico', name: 'Reloj Cósmico', icon: '⏳', price: 70, category: 'Magia', description: 'Retrocede el tiempo del universo para forzar un nuevo día inmediatamente.', chips: ['Poder Cósmico', '1 uso', 'Límite 4/mes'], payload: { type: 'TIME_TRAVEL' } }
  ],
