...
export const createAlbumSlice = (set, get) => ({
  ...
  slots: [
    ...
    // Página 2 (Gatos y Misticismo) - point to Page 1 assets for safe rendering
    { id: 6, pageId: 2, slotNum: 1, state: 'empty', title: 'Gatito Familiar', image: '/Album Mágico/1/crecienteLunar.jpg', bgSvg: '/Album Mágico/1/crecienteLunar.svg', rarity: 'Especial', description: '' },
    { id: 7, pageId: 2, slotNum: 2, state: 'empty', title: 'Caldero de Bruja', image: '/Album Mágico/1/escobaDeBruja.jpg', bgSvg: '/Album Mágico/1/escobaDeBruja.svg', rarity: 'Común', description: '' },
    { id: 8, pageId: 2, slotNum: 3, state: 'empty', title: 'Hierbas Mágicas', image: '/Album Mágico/1/elGato.jpg', bgSvg: '/Album Mágico/1/elGato.svg', rarity: 'Común', description: '' },
    { id: 9, pageId: 2, slotNum: 4, state: 'empty', title: 'Pócima de Amor', image: '/Album Mágico/1/laArana.jpg', bgSvg: '/Album Mágico/1/laArana.svg', rarity: 'Común', description: '' },
    { id: 10, pageId: 2, slotNum: 5, state: 'empty', title: 'Libro de Hechizos', image: '/Album Mágico/1/leMat.jpg', bgSvg: '/Album Mágico/1/leMat.svg', rarity: 'Común', description: '' },
