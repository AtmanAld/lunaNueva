// Moods Positivos: amor, alegría, sorpresa, cariño, contento, extrañeza, perplejidad, curiosidad, encanto, diversión, asombro, agrado, ternura, interés, admiración, dicha, afecto, incredulidad, felicidad, ánimo.
// Moods Negativos: antipatía, desagrado, aversión, hastío, ansiedad, rencor, terror, pánico, ferocidad, melancolía, angustia, furia, susto, coraje, culpa, temor, disgusto, pesar, miedo, enojo.


// casos de mensajes de UI primero se menciona sección de ui, luego se menciona el contexto o cuando ocurre o aparece el mensaje, ignora la numeración ya que es discontínua por que he agrupado los mensajes más bien por forma en que se escribirán en este documento: aquellos sin botón, aquellos con un botón, aquellos con dos botones

//CON BOTON UNICO
7. dashboard, una vez que se llena al 100% la luna y es luna llena (se sorprende y felicita y ofrece obtener tarjeta de recompensa -esta es la tarjeta que luego se coloca en el album-)

19. spiral, mensaje si se selecciona agua y tiene sed (mensaje feliz pidiendo confirmación con boton "Sí, Spiral" (highlighted))
20. spiral, mensaje si se selecciona comida y tiene hambre (mensaje feliz pidiendo confirmación con boton "Sí, Spiral" (highlighted))
21. spiral, mensaje si ses selecciona jabón y quiere bañarse (mensaje de confirmación con botón "Sí, Spiral" (highlighted))
22. spiral, mensaje si se selecciona juguete y quiere jugar (mensaje de confirmación con botón "Sí, Spiral" (highlighted))
23. spiral, mensaje si se selecciona algún item que no tiene en posesión o en inventario (mensaje que ofrece ir a la tienda con botón "Ir a la tienda"(normal))


//CON MULTIPLES BOTONES
9. dashboard, cuando detecta que es un nuevo día, para preguntar si quiere iniciar un nuevo día o revisar el día anterior (botones de "Iniciar nuevo día (highlighted)" y "Mejor reviso antes(normal)")

//SIN BOTONES
2. dashboard, al completar 1 vez una actividad que solo se completa 1 vez
3. dashboard, al cancelar 1 actividad que solo se completa 1 vez
4. dashboard, al completar 1 vez más una actividad que se completa más de 1 vez
5. dashboard, al cancelar 1 actividad que se completa más de 1 vez
6. dashhboard, una vez la fase actual alcanza el 100% y pasa a una nueva fase (un mensaje por cambio de fase 1 a 2, 2 a 3, 3 a 4, 4 a 5)
8. dashboard, una vez se ha cobrado la recompensa de la luna (mensaje de confirmación)

15. spiral, mensaje si se selecciona agua pero no tiene sed
16. spiral, mensaje si se selecciona comida pero no tiene hambre
17. spiral, mensaje si se selecciona jabón pero no necesita baño
18. spiral, mensaje si se selecciona juguete pero no quiere jugar

29. album, al seleccionar una casilla para colocar una carta (botón de )
30. album, al seleccionar una tarjeta para colocar después de lo anterior (tiene contenido además de botones)
31. album, al seleccionar la sexta casilla de la página para desbloquearla y usuaria ha compra do el item en la tienda para desbloquear (tiene botones para confirmar desbloqueo y contenido de imagen del item a usar)
32. album, al seleccionar la sexta casilla de la página para desbloquearla pero no ha adquirido el item necesario en la tienda (con botón para ofrecer ir a comprar en la tienda o regresar)
33. album, al seleccionar una página bloqueada para desbloquearla y usuaria ha compra do el item en la tienda para desbloquear (tiene botones para confirmar desbloqueo y contenido de imagen del item a usar)
34. album, al seleccionar una página bloqueada para desbloquearla pero no ha adquirido el item necesario en la tienda (con botón para ofrecer ir a comprar en la tienda o regresar)
35. album, mensaje de confirmación de desbloqueo de casilla (creo que esto quisiera quitarlo también)
36. album, mensaje de confirmación de desbloqueo de página (creo que esto quisiera quitarlo también)
37. album, mensaje cuando usuaria tiene 5 casillas completas ofreciendo canjear página o llenar la ultima tarjeta para ganar más dinero (botones)
38. album, mensaje cuando usuaria ha llenado las 6 casillas para ofrecer canjear

39. tienda, mensaje al seleccionar una actividad para comprarla con contenido de icono de actividad y chips informativos (además de botones para comprar, regresar y ver detalle de actividad)
40. tienda, cuando se da clic en detalle de actividad mostrando esta información de la misma y botones de comprar y regresar
41. tienda, cuando se compra una actividad confirmando la compra (aún no codificado, no aparece)
42. tienda, cuando no alcanzan las estrellas para comprar algo diciendo que aún no tiene suficientes estrellas, boton de regresar
43. tienda, cuando se selecciona un item que no es actividad y se pide confirmación para comprar y si alcanzan las estrellas (con botones de comprar y regresar, con contenido que es icono de item y chips informativos)

44. perfil, informativo al dar clic en editar foto (con botones para aceptar cambios, contenido especial con boton de subir archivo, cancelar y editar otras cosas)
45. perfil, informativo al dar clic en editar otras cosas después de lo anterior con inputs para cambiar nombre de usuario y nombre de mascota y botones de aceptar cambios y regresar
...
messageCatalog: {
  "SPIRAL_FELIZ": {
    text: [
      "Prrr... te quiero tanto, Amelia. ¿Lo sabes? El universo lo sabe. 💜",
      ...
      "¡Este momento es mágico, Amelia! Tú, yo y las estrellas. Prrr. 🌟",
      ...
      "Amelia, eres la humana más increíble que conozco. Prrr. Te lo juro. 💜",
      ...
      "¡Venga Amelia! ¡Hoy podemos con todo! ¡Tú y yo contra el universo! 🌟"
    ],
  ...
  "SPIRAL_HAMBRE": {
    text: [
      "Amelia. Sin rodeos: dame de comer. Ya. Sin drama. Solo comida.",
      ...
      "Amelia. Dame. De. Comer. Ahora. No es una sugerencia. Es un aviso. 😼",
      "Prr... me siento tan vacía por dentro... y es literal. No he comido. 🌧️",
      ...
      "Prr... es muy triste, Amelia. Mi pancita llora en silencio. 😿",
      "Meow... tengo miedo de olvidar lo que es estar llena... 😨",
  ...
  "SPIRAL_SED": {
    text: [
      ...
      "¡Me rehúso a estar sedienta ni un segundo más! ¡Agua, inmediatamente! 😤",
      ...
      "¡¡Completamente seca por dentro!! ¡¡Protocolo de hidratación urgente!! 😱",
      "Agua. Ahora. Sin preguntas. Sin rodeos. Esto no admite negociación. 😼",
      "Prr... tan sedienta y tan sola en este desierto interior... 🌧️",
  ...
  "SPIRAL_SUCIO": {
    text: [
      ...
      "Me dejaste sucio demasiado tiempo, Amelia. El jabón lo perdonará. 😾",
      "¡¡ESTOY SUCIO!! ¡¡ESTO ES HORRIBLE!! ¡¡BÁÑAME AHORA MISMO!! 🙀",
      "¡¡Suciedad detectada en todo el pelaje!! ¡¡Protocolo baño urgente!! 😱",
      "Amelia. Jabón. Agua. Toalla. Ahora. Sin excusas. Sin rodeos. 😼",
      ...
      "¡Me tiene harto estar sucio! ¡Báñame de una buena vez, Amelia! 😾",
  ...
  "SPIRAL_JUGAR": {
    text: [
      ...
      "Llevamos mucho tiempo sin jugar, Amelia. El juguete lo arreglará. 😾",
      "¡¡El aburrimiento me devora por dentro!! ¡¡Juguete, ya mismo!! 🙀",
      "¡¡Energía sin usar detectada!! ¡¡Esto es una crisis gatuna crítica!! 😱",
      "Amelia. Juguete. Ahora. O le doy a tus cosas. Tú decides. 😼",
      ...
      "¡Ya no aguanto más el aburrimiento! ¡Dame el juguete, Amelia! 😾",
  ...
  "THANKS_FOOD": {
    text: [
      ...
      "Amelia, tienes un don para elegir croquetas. ¡Aquí tienes {{stars}} estrellas en agradecimiento! ⭐",
      ...
      "¡A por el mundo! ¡Ya tengo combustible! ¡Aquí tienes {{stars}} estrellas en agradecimiento! ⭐"
    ],
  ...
  "THANKS_WATER": {
    text: [
      ...
      "Amelia, el agua que me das sabe a gloria. ¡Aquí tienes {{stars}} estrellas en agradecimiento! ⭐",
      ...
      "¡Listos para navegar el día! ¡Aquí tienes {{stars}} estrellas en agradecimiento! ⭐"
    ],
  ...
  "THANKS_WASH": {
    text: [
      ...
      "Amelia, eres la mejor peluquera espacial. ¡Aquí tienes {{stars}} estrellas en agradecimiento! ⭐",
      ...
      "¡A deslumbrar a todos con mi brillo! ¡Aquí tienes {{stars}} estrellas en agradecimiento! ⭐"
    ],
  ...
  "THANKS_PLAY": {
    text: [
      ...
      "Amelia, tienes los mejores trucos de juego. ¡Aquí tienes {{stars}} estrellas en agradecimiento! ⭐",
      ...
      "¡Nada me detiene ahora! ¡A correr! ¡Aquí tienes {{stars}} estrellas en agradecimiento! ⭐"
    ],
  ...
  "LUNA_NUEVA": {
    text: [
      "En el silencio de la oscuridad, Amelia, tu magia se está cocinando. ¡Miau! 🌑✨",
      ...
      "La oscuridad no es vacía, es potencial puro. ¡Vamos a brillar, Amelia! ✨",
  ...
  "LUNA_CRECIENTE": {
    text: [
      ...
      "La magia está brotando. Amelia, cada paso cuenta en esta noche. Prrr. 🐾",
      ...
      "¡Meow! ¡Esa luz te queda increíble, Amelia! ¡A por ello! 💫"
    ],
    video: "assets/videos/spiral_message.mp4",
    actionConfig: []
  },
  ...
  "LUNA_CUARTO_CRECIENTE": {
    text: [
      "¡Media Luna, doble de poder! ¡Siento la fuerza cósmica, Amelia! 🌙💥",
      ...
      "¡Meow! ¡Medio camino recorrido, Amelia! ¡Eres una leyenda lunar! 🌟"
    ],
    video: "assets/videos/spiral_message.mp4",
    actionConfig: []
  },
  ...
  "LUNA_GIBOSA_CRECIENTE": {
    text: [
      ...
      "Amelia, siento un cosquilleo de dopamina estelar. ¡Estás tan cerca! Prrr. 🐾",
  ...
  "LUNA_LLENA": {
    text: [
      "¡EXPLOSIÓN DE LUZ! ¡Eres magnífica, Amelia! ¡Brillamos juntos! 🌕✨",
      "¡Miau! ¡La plenitud total! ¡Celebremos que somos polvo de estrellas! Prrr. 🐾",
      "Toda la luz del cosmos se queda corta ante lo que has logrado hoy. 🌌",
      "¡Meow! ¡Soy un gatito lobo! ¡Auuuu... digo, Miau! ¡Felicidades! 🌕😹",
      "La magia ha florecido. Disfruta este baño de luz, te lo mereces. ✨",
      "Prrr... nada es imposible bajo una Luna como esta. ¡Eres increíble! 🌸",
      "¡Dicha absoluta! ¡El ciclo es perfecto porque tú estás en él! 💫"
    ],
    video: "assets/videos/spiral_message.mp4",
    actionConfig: []
  },
  ...
  "DASHBOARD_FULL_MOON": {
    text: [
      "¡Miau! ¡La luna está completamente llena! Es hora de celebrar, Amelia. ¡Reclama tu recompensa lunar! 🌕✨"
    ],
    video: "assets/videos/spiral_message.mp4",
    actionConfig: [
      { label: "Obtener recompensa", type: "CLAIM_MOON_REWARD", variant: "highlighted", icon: "star" }
    ]
  },
  ...
  "GO_TO_STORE_NO_ITEM": {
    ...
    video: "assets/videos/spiral_message.mp4",
    actionConfig: [
      { label: "Ir a la tienda", type: "NAVIGATE_STORE", variant: "normal", icon: "store" },
  ...
  "NEW_DAY_PROMPT": {
    text: [
      "¡Buenos días, Amelia! He notado que es un nuevo día. ¿Empezamos con energía nueva o revisamos qué hicimos ayer? 🌅🐾"
    ],
    video: "assets/videos/spiral_message.mp4",
    actionConfig: [
  ...
  "ACTIVITY_COMPLETE_SINGLE": {
    text: [
      "¡Excelente trabajo! Has completado esta actividad. ¡Un paso más! 🐾✨"
    ],
    video: "assets/videos/spiral_message.mp4",
    duration: 3000,
    actionConfig: []
  ...
  "ACTIVITY_CANCEL_SINGLE": {
    text: [
      "Actividad desmarcada. No te preocupes, ¡siempre podemos retomarla después! 🐱💫"
    ],
    video: "assets/videos/spiral_message.mp4",
    duration: 3000,
    actionConfig: []
  ...
  "ACTIVITY_COMPLETE_MULTIPLE": {
    text: [
      "¡Muy bien! Sumaste otra vez a esta actividad. ¡Sigue así! 🚀✨"
    ],
    video: "assets/videos/spiral_message.mp4",
    duration: 3000,
    actionConfig: []
  ...
  "ACTIVITY_CANCEL_MULTIPLE": {
    text: [
      "Le restamos una vez a esta actividad. ¡Poco a poco se llega lejos! 🐾"
    ],
    video: "assets/videos/spiral_message.mp4",
    duration: 3000,
    actionConfig: []
  ...
  "PHASE_CHANGE": {
    text: [
      "¡Mira arriba, Amelia! Hemos entrado a una nueva fase lunar. ¡La magia fluye! 🌙✨"
    ],
    video: "assets/videos/spiral_message.mp4",
    duration: 4000,
    actionConfig: []
  ...
  "MOON_REWARD_CLAIMED": {
    text: [
      "¡Recompensa asegurada! Esa tarjeta se verá preciosa en tu álbum. ¡Miau! 🃏💖"
    ],
    video: "assets/videos/spiral_message.mp4",
    duration: 3000,
    actionConfig: []
  ...
  "STORE_NOT_ENOUGH_STARS": {
    text: [
      "¡Ups! Amelia, aún no tienes suficientes estrellas para esto. ¡Sigue brillando para ganar más! ⭐🐾"
    ],
    video: "assets/videos/spiral_message.mp4",
    duration: 1500,
    actionConfig: []
